...
def apply_offline_augmentations(dataset_dir, split):
    print("[2/3] Starting offline data augmentations...")
    train_img_folder = os.path.join(dataset_dir, split, "images")
    train_label_folder = os.path.join(dataset_dir, split, "labels")
...
if __name__ == "__main__":
    for i in ["test", "train" ,"valid"]:
        apply_offline_augmentations("dataset", i)